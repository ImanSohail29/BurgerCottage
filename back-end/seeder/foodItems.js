...
const foodItems=[
{
    ...
    size:[{value:"medium","price":350},{value:"large","price":400}],
    addOns:[{}],
    attributes:[{"size":[{"medium":{"price":350}},{"large":{"price":400}}]}],
    addOns:[new ObjectId('658c043bde4af518198e7ca4'),new ObjectId('658c043bde4af518198e7ca6')],
    price:'',
    ingredients:[],
    quantity:'',
    reviews:[],
...
},
{
    ...
    size:[{value:"regular","price":150},{value:"large","price":250},{value:"family","price":300}],
